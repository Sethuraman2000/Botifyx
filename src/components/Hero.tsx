      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          <div className="mb-12 lg:mb-0">
            ...
            >
              Transform Your Business with <span className="gradient-text">Botifyx AI</span>
            </motion.h1>
            ...
            >
              Botifyx helps businesses automate workflows, gain valuable insights, and boost productivity with our cutting-edge artificial intelligence solutions.
            </motion.p>
            ...
            >
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600">
                  <span className="font-medium text-gray-900">4.9/5</span> from over 1,000+ reviews
                </p>
              </div>
            </motion.div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="px-6 pt-6 pb-10">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-lg font-semibold">Botifyx Assistant</span>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div className="bg-gray-100 rounded-2xl rounded-tl-none px-4 py-2 text-sm">
                        Can you analyze our Q2 sales data and identify trends?
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="bg-primary-50 rounded-2xl rounded-tl-none px-4 py-2 text-sm">
                        <p>I've analyzed your Q2 sales data and found several key trends:</p>
                        <ul className="mt-2 space-y-1 list-disc list-inside">
                          <li>Revenue increased by 24% compared to Q1</li>
                          <li>Product A showed the highest growth at 37%</li>
                          <li>Customer retention improved to 92%</li>
                        </ul>
                        <p className="mt-2">Would you like me to generate a detailed report with recommendations?</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="bg-gray-100 rounded-2xl rounded-tl-none px-4 py-2 text-sm">
                        Yes, please generate a report and suggest ways to improve our Q3 performance.
                      </div>
                    </div>
                    
                    <div className="flex items-center">
                      <div className="h-0.5 flex-1 bg-gray-200"></div>
                      <span className="px-2 text-xs text-gray-500">Generating report...</span>
                      <div className="h-0.5 flex-1 bg-gray-200"></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 px-6 py-4 flex">
                  ...
                  />
                  <button className="ml-2 p-2 rounded-lg bg-primary-600 text-white">
